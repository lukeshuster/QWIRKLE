...
class Board{
    public:
        ...
        //Loads a tile to any given x and y location on the board
        void loadTile(int x, int y, Tile* tile);

        int allDirections(int x, int y, Tile* tile);

        void tileHint(Tile* tile);
        ...
        //returns the contents of the board in saveable format
